...
"""
Keejob Web Scraper
Scrapes job listings from Keejob.com
"""
...
class KeejobScraper:
    """Web scraper for Keejob.com job listings"""
    ...
    def scrape_listing_page(self, page_num):
        ...
        url = f"https://www.keejob.com/offres-emploi/?keywords=&professions=%5B24%5D&page={page_num}"
...
def main():
    ...
    # Scrape all pages
    scraper.scrape_all_pages(num_pages=4)
    
    # Show statistics
    scraper.get_statistics()
    
    # Save to both CSV and JSON
    scraper.save_to_csv('keejob_listings.csv')
    scraper.save_to_json('keejob_listings.json')
